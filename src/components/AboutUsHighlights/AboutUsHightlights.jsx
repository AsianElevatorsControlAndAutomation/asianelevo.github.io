  ...
  return (
    <div className='p-10'>
        ...
        <div className='grid grid-cols-6 mt-3'>
            <div className='col-span-6 md:col-span-4 pr-5'>
            ...
            <div className='md-[hvr-grow] hidden md:block md:col-span-2 2xl:col-span-1'>
                <Link href={'/about-us'}>
                    <img src='/AboutUsHighlight.png' alt="About Us Asian" className='border rounded-3xl' />
                </Link>
            </div>
        </div>
    </div>
