  ...
  return (
    <div className='md:container md:mx-auto p-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2'>            
            <div className='startAnimationRight'>
                ...
                {ContactInformation.email.map((email, idx)=>
                    <div className='flex entryAnimateRight' key={idx}>
                ...
                <div className='mt-10'>
                    <div className={`text-white-900 font-extrabold entryAnimateRight`}>Find us on:</div>
                    <div className='grid grid-cols-2 max-md:gap-2'>
                        ...
                        <div className='flex' key={idx}>
                            <Link href={social.url} className='hover:underline'  target='_blank'>
                                <img src={social.image} alt={`asian elevators ${social.type} icon`} className='h-20 w-full bg-sky-50 pl-2 pr-2 m-1 rounded-3xl entryAnimateRight' />
                            </Link>
                        </div>
                        )}
                    </div>
            ...
            <div className='startAnimationLeft'>
        ...
        <div>
            ...
            className='w-full h-96 rounded-3xl mt-10 entryAnimateDown' allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
        </div>
        <FAQ />
    </div>
  )
