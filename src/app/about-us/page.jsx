    ...
    <div className='md:container mx-auto container mb-20'>
        ...
        <div className='grid md:grid-cols-2'>
          <div className='flex flex-col gap-2 p-4'>
            <h2 className='text-3xl revue flex justify-center'>Our Company</h2>
            ...
            <h2 className='text-3xl revue flex justify-center'>Our Mission</h2>
            ...
            <h2 className='text-3xl revue flex justify-center'>Our Vision</h2>
          ...
          <img src="/about-us.jpg" alt="About Asian Elevators Image" className={`aboutus-img rounded-3xl`} />
        </div>
          ...
          <div className='eventContainer'>
              ...
              <div className={`grid xs:grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-20 eventImageContainer`}>
                  {AboutUsInformation.awards.images.map((image, idx2)=>(
                      <figure key={idx2} className="blue frame flex justify-center">
                          <img src={`/aboutUs/${AboutUsInformation.awards.folderName}/${image.img}`} alt={image.alt} className='h-72 w-auto self-center'/>
                          <figcaption>
                              <h2>{image.alt}</h2>
          ...
          <div className='eventContainer'>
              ...
              <div className={`grid xs:grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-20 eventImageContainer`}>
                  {AboutUsInformation.certificates.images.map((image, idx2)=>(
                      <figure key={idx2} className="blue frame flex justify-center">
                          <img src={`/aboutUs/${AboutUsInformation.certificates.folderName}/${image.img}`} alt={image.alt} className='h-72 w-auto'/>
                          <figcaption>
